 ...
 */
#define VIM_ERR_APPID  (0x80000000L + 0x20000000L)

typedef enum vimERR_LEVEL_E
{
...
#define VIM_DEF_ERR( module, level, errid) \
    ((VIM_S32)( (VIM_ERR_APPID) | ((module) << 16 ) | ((level)<<13) | (errid) ))

/* NOTE! the following defined all common error code,
** all module must reserved 0~63 for their common error code
*/
typedef enum vimEN_ERR_CODE_E
{
